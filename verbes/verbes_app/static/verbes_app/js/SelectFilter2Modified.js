...
'use strict';
{
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            // ADDED
            choose_all_false.addEventListener('click', function(e) {
                move_selection(e, this, SelectBox.move_all_false, field_id + '_from', field_id + '_to');
            });
            choose_all_not_done.addEventListener('click', function(e) {
                move_selection(e, this, SelectBox.move_all_not_done, field_id + '_from', field_id + '_to');
            });
            clear_all_false.addEventListener('click', function(e) {
                move_selection(e, this, SelectBox.move_all_false, field_id + '_to', field_id + '_from');
            });
            clear_all_not_done.addEventListener('click', function(e) {
                move_selection(e, this, SelectBox.move_all_not_done, field_id + '_to', field_id + '_from');
            });
            // END ADDED
        ...
        refresh_icons: function(field_id) {
            ...
            // ADDED
            document.getElementById(field_id + '_add_all_false_link').classList.toggle('active', from.querySelector('.unsuccess'));
            document.getElementById(field_id + '_remove_all_false_link').classList.toggle('active', to.querySelector('.unsuccess'));
            document.getElementById(field_id + '_add_all_not_done_link').classList.toggle('active', from.querySelector('.not-done'));
            document.getElementById(field_id + '_remove_all_not_done_link').classList.toggle('active', to.querySelector('.not-done'));
            // END ADDED
        },
